...
0x15. API
 ...
 Weight: 1
 Project over - took place from 01-31-2022 to 02-01-2022 - you're done with 0% of tasks.
 An auto review will be launched at the deadline
In a Auto QA review: 0.0/21 mandatory
Altogether:  0.0%
Mandatory: 0.0%
...
You must use get to access to dictionary value by key (it t throw an exception if the key t exist in the dictionary)
...
Copyright doesnwondonletnutshell