...
0x16. API advanced
 ...
 Weight: 1
 Project over - took place from 02-15-2022 to 02-16-2022 - you're done with 0% of tasks.
 An auto review will be launched at the deadline
In a Auto QA review: 0.0/17 mandatory & 0.0/14 optional
Altogether:  0.0%
Mandatory: 0.0%
Optional: 0.0%
...
Hint: No authentication is necessary for most features of the Reddit API. If re getting errors related to Too Many Requests, ensure re setting a custom User-Agent.
...
Copyright ityouyouyoutheredonThereendpointas theynutshell